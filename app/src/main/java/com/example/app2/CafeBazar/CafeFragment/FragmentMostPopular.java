            ...
            public void onScrollChange(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
                if (v.getChildAt(v.getChildCount() - 1) != null) {
                    if ((scrollY >= (v.getChildAt(v.getChildCount() - 1).getMeasuredHeight() - v.getMeasuredHeight())) &&
                        ...
                        getMostPopularApp();
//                        Toast.makeText(getContext(), "end list most popular", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
...
//        });
    ...
    private void setupViews() {
        ...
        nestedScrollView = (NestedScrollView) view.findViewById(R.id.nst_fragmentMostPopular_nestedScrollView);
        imgSlide = (ImageView) view.findViewById(R.id.img_fragmentMostPopular_slide);
        progressBar = (ProgressBar) view.findViewById(R.id.progress_mostPopular);
        recyclerView = (RecyclerView) view.findViewById(R.id.rv_fragmentMostPopular_mostPopularRecycler);
    ...
    private void getMostPopularApp() {
